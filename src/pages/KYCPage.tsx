        ...
        >
          ...
          <button
            ...
            style={{
              ...
              background: isDark ? "rgba(255,255,255,0.1)" : "#1e3a8a",
              boxShadow: isDark
            ...
            onMouseEnter={(e) => {
              if (!loading)
                e.currentTarget.style.background = isDark ? "rgba(255,255,255,0.18)" : "#1e40af";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = isDark ? "rgba(255,255,255,0.1)" : "#1e3a8a";
            }}
          >
            {loading ? (
              <>
